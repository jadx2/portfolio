        ...
        <div className="about__cards">
          <div className="about__cards__container">
            ...
            <div className="about__card">
              ...
              <h3 className="about__card__title">Frameworks</h3>
              <div className="about__card__items">
                <p className="about__card__item">SCSS</p>
                <p className="about__card__item">React</p>
                <p className="about__card__item">Ruby on Rails</p>
              </div>
            </div>
            <div className="about__card">
              ...
              <div className="about__card__items">
                ...
                <p className="about__card__item">Terminal</p>
